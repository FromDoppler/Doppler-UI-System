   ...
   */
  var vLang = document.documentElement.lang,
   countries_en = [
    ...
    countries_es = [
      ["Afganinstan (افغانستان)", "af", "93"],
      ["Albania (Shqipëri)", "al", "355"],
      ["Alemania (Alemania)", "de", "49"],
      ["Andorra", "ad", "376"],
      ["Angola", "ao", "244"],
      ["Anguila", "ai", "1264"],
      ["Antigua y Barbuda", "ag", "1268"],
      ["Arabia Saudita (المملكة العربية السعودية)", "sa", "966"],
      ...
      ["Ciudad del Vaticano (Città del Vaticano)", "va", "39", 1],
      ["Colombia", "co", "57"],
      ["Comoras (جزر القمر)", "km", "269"],
      ["Congo (RDC) (Jamhuri ya Kidemokrasia ya Kongo)", "cd", "243"],
      ["Congo (República) (Congo-Brazzaville)", "cg", "242"],
      ...
      ["Eritrea", "er", "291"],
      ["Eslovaquia (Slovensko)", "sk", "421"],
      ["Eslovenia (Eslovenia)", "si", "386"],
      ["España (Spain)", "es", "34"],
      ...
      ["Isla Norfolk", "nf", "672"],
      ["Islandia (Ísland)", "es", "354"],
      ["Islas Aland", "ax", "358", 1],
      ["Islas Caimán", "ky", "1345"],
      ["Islas Cocos (Keeling)", "cc", "61", 1],
      ["Islas Cook", "ck", "682"],
      ["Islas Feroe (Føroyar)", "fo", "298"],
      ["Islas Malvinas (Falkland Islands)", "fk", "500"],
      ["Islas Marianas del Norte", "pf", "1670"],
      ["Islas Marshall", "mh", "692"],
      ["Islas Salomón", "sb", "677"],
      ["Islas Turcas y Caicos", "tc", "1649"],
      ["Islas Vírgenes Británicas", "vg", "1284"],
      ["Islas Vírgenes de los Estados Unidos", "vi", "1340"],
      ["Israel (ישראל)", "il", "972"],
      ["Italia (Italia)", "it", "39", 0],
      ["Jamaica", "jm", "1", 4, ["876", "658"]],
      ["Japón (日本)", "jp", "81"],
      ["Jersey", "je", "44", 3],
      ["Jordan (الأردن)", "jo", "962"],
      ["Kazajstán (Казахстан)", "kz", "7", 1],
      ["Kenia", "ke", "254"],
      ["Kirguistán (Кыргызстан)", "kg", "996"],
      ["Kiribati", "ki", "686"],
      ["Kosovo", "xk", "383"],
      ["Kuwait (الكويت)", "kw", "965"],
      ["La Reunión (La Reunión)", "re", "262", 0],
      ["Laos (ລາວ)", "la", "856"],
      ["Lesotho", "ls", "266"],
      ...
      ["Luxemburgo", "lu", "352"],
      ["Macau (澳門)", "mo", "853"],
      ["Macedonia (ARYM) (Македонија)", "mk", "389"],
      ["Madagascar (Madagasikara)", "mg", "261"],
      ["Malasia", "my", "60"],
      ["Malawi", "mw", "265"],
      ["Maldivas", "mv", "960"],["Mali", "ml", "223"],
      ["Malta", "mt", "356"],
      ["Marruecos (المغرب)", "ma", "212", 0],
      ["Martinica", "mq", "596"],
      ...
      ["Rusia (Россия)", "ru", "7", 0],
      ["Sahara Occidental (الصحراء الغربية)", "eh", "212", 1],
      ["Saint Kitts y Nevis", "kn", "1869"],
      ["Saint Martin (Saint-Martin (partie française))", "mf", "590", 2],
      ["Samoa Americana", "as", "1684"],
      ["Samoa", "ws", "685"],
      ["San Bartolomé", "bl", "590", 1],
      ["San Marino", "sm", "378"],
      ["San Pedro y Miquelón (San Pedro y Miquelón)", "pm", "508"],
      ["San Vicente y las Granadinas", "vc", "1784"],
      ["Santa Helena", "sh", "290"],
      ["Santa Lucía", "lc", "1758"],
      ["Santo Tomé y Príncipe (Santo Tomé y Príncipe)", "st", "239"],
      ["Senegal (Sénégal)", "sn", "221"],
      ["Serbia (Србија)", "rs", "381"],
      ["Seychelles", "sc", "248"],
      ["Sierra Leona", "sl", "232"],
      ...
      ["Swazilandia", "sz", "268"],
      ["Tailandia (ไทย)", "th", "66"],
      ["Taiwán (台灣)", "tw", "886"],["Tajikistan", "tj", "992"],
      ["Tanzania", "tz", "255"],
  ...
  var countries_array =(vLang == 'en') ? countries_en : countries_es;
  ! function(a) {
    var b = function(a, b, c) {
      ...
      return function() {
        ...
        for (var f = countries_array, g = 0; g < f.length; g++) {
          var h = f[g];
          f[g] = {
            name: h[0],
            iso2: h[1],
